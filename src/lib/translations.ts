...
export const translations: Translations = {
  ...
  supabase_project_url_desc: { ar: 'مطلوب لنظام الإشعارات الجديد الموثوق. يمكنك العثور عليه في لوحة تحكم Supabase > إعدادات المشروع > API > Project URL.', en: 'Required for the new reliable notification system. Find it in your Supabase Dashboard > Project Settings > API > Project URL.'},
  discord_proxy_secret: { ar: 'كلمة سر وكيل ديسكورد', en: 'Discord Proxy Secret' },
  discord_proxy_secret_desc: { ar: 'أنشئ كلمة مرور قوية وعشوائية. سيتم استخدام كلمة المرور هذه لتأمين الاتصال بين قاعدة البيانات ووظيفة وكيل الإشعارات.', en: 'Create a strong, random password. This password will be used to secure the connection between the database and the notification proxy function.'},
  submissions_channel_id: { ar: 'معرف قناة التقديمات', en: 'Submissions Channel ID'},
  submissions_channel_id_desc: { ar: 'المعرف الرقمي للقناة التي تستقبل إشعارات التقديمات الجديدة.', en: 'The ID of the channel that receives new submission notifications.'},
  submissions_mention_role_id: { ar: 'معرف رتبة منشن التقديمات', en: 'Submissions Mention Role ID'},
  submissions_mention_role_id_desc: { ar: 'المعرف الرقمي للرتبة التي يتم عمل منشن لها عند وجود تقديم جديد.', en: 'The ID of the role to mention when a new submission arrives.'},
  audit_log_channel_id: { ar: 'معرف قناة سجل التدقيق العام', en: 'General Audit Log Channel ID'},
  ...
  // FIX: Escaped single quote in the string.
