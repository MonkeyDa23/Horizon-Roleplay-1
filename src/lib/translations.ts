...
export const translations: Translations = {
  ...
  admin_session_error_warning: { ar: 'لا يمكن التحقق من جلسة المشرف مع الخادم. قد تكون البيانات المعروضة قديمة.', en: 'Could not verify admin session with the server. Displayed data might be outdated.'},
