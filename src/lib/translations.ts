...
export const translations: Translations = {
  ...
  health_check_desc: { ar: 'هذه الصفحة تساعد في تشخيص مشاكل الإعدادات. تأكد من أن كل الفحوصات باللون الأخضر ليعمل الموقع بشكل صحيح.', en: 'This page helps diagnose configuration issues. Ensure all checks are green for the site to function correctly.'},
  health_check_step1: { ar: 'الخطوة 1: رابط Supabase OAuth Redirect URI', en: 'Step 1: Supabase OAuth Redirect URI'},
  health_check_step1_desc: { ar: 'لكي يعمل تسجيل الدخول، يجب إضافة هذا الرابط في إعدادات Discord Provider داخل Supabase Authentication.', en: 'For login to work, you must add this URI in your Supabase Authentication > Providers > Discord settings.'},
  health_check_uri_label: { ar: 'رابط Redirect URI المطلوب:', en: 'Your Required Redirect URI:'},
  health_check_copy: { ar: 'نسخ', en: 'Copy'},
  health_check_copied: { ar: 'تم النسخ!', en: 'Copied!'},
  health_check_step2: { ar: 'الخطوة 2: تشخيصات الخادم', en: 'Step 2: Server Diagnostics'},
  health_check_env_vars: { ar: 'متغيرات البيئة (Environment Variables)', en: 'Environment Variables'},
  health_check_env_vars_desc: { ar: 'يفحص ما إذا كانت المتغيرات السرية المطلوبة معرفة في بيئة التشغيل.', en: 'Checks if the required secrets are set in your hosting environment.'},
  health_check_supabase_connection: { ar: 'الاتصال بـ Supabase', en: 'Supabase Connection'},
  health_check_supabase_desc: { ar: 'يختبر ما إذا كان يمكن للواجهة الأمامية الاتصال بقاعدة بيانات Supabase.', en: 'Tests if the frontend can connect to your Supabase database.'},
  health_check_db_status: { ar: 'حالة قاعدة البيانات:', en: 'DB Status:'},
  health_check_overall_status: { ar: 'الحالة العامة', en: 'Overall Status'},
  health_check_error: { ar: 'خطأ في الإعدادات', en: 'Configuration Error'},
  health_check_error_desc: { ar: 'فشل فحص واحد أو أكثر. يرجى مراجعة الأخطاء أعلاه. لن يعمل تسجيل الدخول حتى تصبح كل الفحوصات خضراء.', en: 'One or more checks failed. Please review the errors above. Login will not work until all checks are green.'},
  health_check_success: { ar: 'كل الأنظمة تعمل', en: 'All Systems Operational'},
  health_check_success_desc: { ar: 'الخادم معرف بشكل صحيح. إذا أكملت الخطوة 1، يجب أن يعمل تسجيل الدخول الآن.', en: 'The server is configured correctly. If you have completed Step 1, login should now work.'},
