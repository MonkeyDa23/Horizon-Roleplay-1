...
import { getQuizzes, getSubmissionsByUserId } from '../src/lib/api';
import type { Quiz, QuizSubmission } from '../src/types';
...
const AppliesPage: React.FC = () => {
  ...
  useEffect(() => {
    // FIX: Fetch quizzes and user submissions from the API
