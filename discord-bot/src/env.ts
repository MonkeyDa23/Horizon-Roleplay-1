...
export const env = {
  ...
  FORCE_UNLINK_ROLE_ID: process.env.FORCE_UNLINK_ROLE_ID,
  LOG_PING_ROLE_MTA: process.env.LOG_PING_ROLE_MTA,
  LOG_PING_ROLE_COMMANDS: process.env.LOG_PING_ROLE_COMMANDS,
  LOG_PING_ROLE_AUTH: process.env.LOG_PING_ROLE_AUTH,
  LOG_PING_ROLE_ADMIN: process.env.LOG_PING_ROLE_ADMIN,
  LOG_PING_ROLE_STORE: process.env.LOG_PING_ROLE_STORE,
  LOG_PING_ROLE_FINANCE: process.env.LOG_PING_ROLE_FINANCE,
  LOG_PING_ROLE_SUBMISSIONS: process.env.LOG_PING_ROLE_SUBMISSIONS,
  LOG_PING_ROLE_VISITS: process.env.LOG_PING_ROLE_VISITS,
